...
from ragpill.utils import _normalize_text, _normalize_text
...
def test_normalize_real():
    ...
    normalized = _normalize_text(input)
...
def test_normalize_quotes():
    ...
    assert _normalize_text("syria’s past nuclear activities") == _normalize_text("Syria's past nuclear\n\n    activities.")
